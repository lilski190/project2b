        ...
        <div className="drawer ">
          ...
          <div className="drawer-content flex flex-col">
            ...
            <div className="navbar bg-base-300 w-full fixed top-0 z-10">
              ...
              <div className="mx-2 flex-1 px-2">Projekttitel: PrimärÄrzte</div>
            ...
            {/* Page content here */}
            <div className="mt-16 py-24 px-10 bg-base-100">{children}</div>
          </div>
          <div className="drawer-side z-20">
            ...
            <ul className="menu bg-base-200 min-h-full w-80 p-4">
              ...
              <li>
                <Link href={`/${lang}/pro`}>Pro Argumente</Link>
              </li>
              <li>
                <Link href={`/${lang}/contra`}>Contra Argumente</Link>
              </li>
              <li>
                <Link href={`/${lang}/list`}>Arguemten Liste</Link>
              </li>
            </ul>
          </div>
        </div>
